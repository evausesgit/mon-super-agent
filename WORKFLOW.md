...
The Notion-driven runner that automated task execution against this repo was extracted to <https://github.com/evausesgit/notion-orchestrator>. Operational conventions for Notion tasks, statuses, and run artifacts live there.
